...
(async function run() {
  ...
  assert.equal(ok.position.payout, base.positionAmount);
  assert.equal(ok.vaultAmount, base.vaultAmount - base.positionAmount);
  assert.equal(ok.userUsdcAmount, base.userUsdcAmount + base.positionAmount);
  ...
  assert.equal(ok.event.payout, base.positionAmount);
